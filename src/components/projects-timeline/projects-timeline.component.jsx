			...
			<Timeline>
				<Events>
					...
					<ImageEvent
						...
						text="DAP(Data Aggregation Platform)"
						src={L_ReactToDoList}
						alt="Yodlee DAP"
					>
								...
								<Accordion>
									<Card>
										...
										<Accordion.Collapse eventKey="0" className="text-left">
											<Card.Body>
												<strong>Description:</strong> Data Aggregation with our well-defined
												Screen Scraping mechanism. This entire mechanism incorporated Core Java
												as its Agent. We build these Agents for propagating Data to the various
												check points. For example, the data that comes through the Agents get
												stored in DB which can further be processed according to the business
												requirements.
												<hr />
												<strong>Features:</strong>
												<ul className="list-styles pt-1">
													<li>Selenium-Java based API's for web scraping.</li>
													<li>Agent development for Finanicial institutions operations.</li>
												</ul>
												<hr />
							...
							<div>
								<Accordion>
									<Card>
										...
										<Accordion.Collapse eventKey="0" className="text-left">
											<Card.Body>
												<strong>Description:</strong> This app calculates Tip for the amount
												entered and percentage of tip to be given. It uses MERN stack build to
												acomplish the same.
												<hr />
												<strong>Features:</strong>
												<ul className="list-styles pt-1">
							...
							<div>
								<Accordion>
									<Card>
										...
										<Accordion.Collapse eventKey="0" className="text-left">
											<Card.Body>
												<strong>Description:</strong> An app that searches people on GitHub with
												non-private account and see all their details using GitHub API
												<hr />
												<strong>Features:</strong>
												<ul className="list-styles pt-1">
							...
							<div>
								<Accordion>
									<Card>
										...
										<Accordion.Collapse eventKey="0" className="text-left">
											<Card.Body>
												<strong>Description:</strong> An app that allows to search through
												robots fetched in real-time with users.
												<hr />
												<strong>Features:</strong>
												<ul className="list-styles pt-1">
							...
							<div>
								<Accordion>
									<Card>
										...
										<Accordion.Collapse eventKey="0" className="text-left">
											<Card.Body>
												<strong>Description:</strong> This website is a clone of Product Hunt
												built using Django.
												<hr />
												<strong>Features:</strong>
												<ul className="list-styles pt-1">
							...
							<div>
								<Accordion>
									<Card>
										...
										<Accordion.Collapse eventKey="0" className="text-left">
											<Card.Body>
												<strong>Description:</strong> This is my first portfolio website built
												using Django.
												<hr />
												<strong>Features:</strong>
												<ul className="list-styles pt-1">
												...
												<em>
													...
													<br />
													<br />
													If you are reading this, that means I have updated my Portfolio
													website to recent one.
													<br />
													You can still see a video of my old portfolio by clicking on the
													button below.
													<br />
													<br />
												</em>
